...
# Unit tests for OpenapiClient::CustomerPayloadCustomerExamination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CustomerPayloadCustomerExamination' do
  before do
    # run before each test
    @instance = OpenapiClient::CustomerPayloadCustomerExamination.new
  end
  ...
  describe 'test an instance of CustomerPayloadCustomerExamination' do
    it 'should create an instance of CustomerPayloadCustomerExamination' do
      expect(@instance).to be_instance_of(OpenapiClient::CustomerPayloadCustomerExamination)
    end
  end
