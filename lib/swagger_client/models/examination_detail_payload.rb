...
module SwaggerClient
  ...
  class ExaminationDetailPayload
    # 小計
    ...
    def list_invalid_properties
      ...
      if @quantity < -2147483648
        invalid_properties.push("invalid value for 'quantity', must be greater than or equal to -2147483648.")
      end
    ...
    def valid?
      ...
      return false if @quantity < -2147483648
    ...
    def quantity=(quantity)
      ...
      if quantity < -2147483648
        fail ArgumentError, "invalid value for 'quantity', must be greater than or equal to -2147483648."
      end
    ...
    def hash
      [amount, description, quantity, unit_price].hash
    end
