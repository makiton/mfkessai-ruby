...
module OpenapiClient
  ...
  class Customer
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'has_alert')
        self.has_alert = attributes[:'has_alert']
      end
    ...
    def hash
      [created_at, has_alert, id, name, number, object, payment_method, uri].hash
    end
