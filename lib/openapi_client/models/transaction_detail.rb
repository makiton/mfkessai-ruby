...
module OpenapiClient
  ...
  class TransactionDetail
    ...
    def list_invalid_properties
      ...
      if !@quantity.nil? && @quantity < -2147483648
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new('String', ["transaction_detail"])
      ...
      return false if !@quantity.nil? && @quantity < -2147483648
      true
    end
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["transaction_detail"])
    ...
    def hash
      [amount, description, object, tax_rate_type, unit_price, quantity, tax_included_type].hash
    end
