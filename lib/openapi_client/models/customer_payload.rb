...
module OpenapiClient
  ...
  class CustomerPayload
    ...
    attr_accessor :customer_examination
    ...
    def self.openapi_types
      {
        ...
        :'customer_examination' => :'CustomerPayloadCustomerExamination',
        :'name' => :'String',
        :'number' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CustomerPayload` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CustomerPayload`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'customer_examination')
        self.customer_examination = attributes[:'customer_examination']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          customer_examination == o.customer_examination &&
          name == o.name &&
          number == o.number
    end
    ...
    def hash
      [destination, customer_examination, name, number].hash
    end
